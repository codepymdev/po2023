...
class DashboardSignOut extends StatefulWidget {
  ...
  DashboardSignOut({Key? key}) : super(key: key);
  @override
  _DashboardSignOutScreenState createState() => _DashboardSignOutScreenState();
}

class _DashboardSignOutScreenState extends State<DashboardSignOut> {
  @override
  void initState() {
    super.initState();
  }
                    ...
                    child:Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: Constants.smallPadValue,),
                          NormalText(myText: 'Upload Result', themeData: themeData,),
                          SizedBox(height: Constants.smallPadValue,),
                          BoldText(myText: 'Sign Out', themeData: themeData,),
                        ],
                      ),
                    )
                ),
